import { GoldTitleComponent, GrayTitleComponent } from "@/components/reusables";
...
export const PLANS = [
  ...
  },
  {
    ...
    featured: true,
    planId: "cplan_3C8kNDtqPo6HRgSot1q1BowQG9z",
    slug: "starter",
    features: [
  ...
  },
  {
    ...
    featured: false,
    planId: "cplan_3CgVvsHL9rln8x58CE6zkIczIve",
    slug: "pro",
    features: [
...
export const ROLES = [
  {
    label: "Interviewee",
    title: React.createElement(GrayTitleComponent, null, "Land the role you deserve"),
  ...
  {
    label: "Interviewer",
    title: React.createElement(GoldTitleComponent, null, "Earn doing what you're great at"),
